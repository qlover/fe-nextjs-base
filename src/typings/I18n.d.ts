...
declare namespace I18n {
  ...
  type Pathname = '/' | '/support' | '/test';

  type I18nNS = 'common' | 'index' | 'support' | 'test'
  ...
  type LocalesTranMap = { 
    ...
    'support': '$seo_desc' | '$seo_keywords' | '$seo_title'
    'test': '$seo_desc' | '$seo_keywords' | '$seo_title' | 'i18n_component_faq' | 'i18n_component_faq2' | 'test_pagetitle'
  }
